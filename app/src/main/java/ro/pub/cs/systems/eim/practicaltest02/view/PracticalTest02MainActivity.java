...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private EditText valuteEditText = null;
    ...
    private class GetResultButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            String valute = valuteEditText.getText().toString();
            if (valute == null || valute.isEmpty()) {
                Toast.makeText(getApplicationContext(), "[MAIN ACTIVITY] Parameter from client (valute) should be filled", Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        valuteEditText = (EditText)findViewById(R.id.valute_edit_text);
        getResultButton = (Button)findViewById(R.id.get_result_button);
        getResultButton.setOnClickListener(getResultButtonClickListener);
        resultTextView = (TextView)findViewById(R.id.bitcoin_text_view);
    }
